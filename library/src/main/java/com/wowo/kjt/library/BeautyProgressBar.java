...
public class BeautyProgressBar extends ProgressBar {
    ...
    public BeautyProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BeautyProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.BeautyProgressBar);
        mProgressbarHeight = (int) ta.getDimension(R.styleable.BeautyProgressBar_progressbar_height, PROGRESSBAR_DEFAULT_HEIGHT);
        mReachColor = ta.getColor(R.styleable.BeautyProgressBar_reach_color, PROGRESSBAR_DEFAULT_REACH_COLOR);
        mUnReachColor = ta.getColor(R.styleable.BeautyProgressBar_unreach_color, PROGRESSBAR_DEFAULT_UNREACH_COLOR);
