...
public class IOSProgressBar extends NumberProgressBar {
    ...
    public IOSProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.RoundNumberProgressBar);
        mRadius = (int) ta.getDimension(R.styleable.RoundNumberProgressBar_progressbar_radius, mRadius);
        ta.recycle();
